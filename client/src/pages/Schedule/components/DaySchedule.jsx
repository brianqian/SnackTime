      ...
      .then(resp => {
        ...
        if (resp) {
          resp.forEach(activity => {
            let activityRow = [];
            activityRow.push(
              moment(activity.activityStartTime, "HH:mm:ss").format("hh:mm A"),
              moment(activity.activityEndTime, "HH:mm:ss").format("hh:mm A"),
      ...
      return (
        <div>
          <div>
            <ResponsiveTable
              title="Schedule"
              columns={["Start Time", "End Time", "Category", "Activity"]}
            ...
            <div className="add-daily-activity">
              <form>
                ...
                <Button
                  ...
                  onClick={e => {
                    this.handleSubmitNewActivity(e, this.state.day);
                  }}
                  type="submit"
                >
